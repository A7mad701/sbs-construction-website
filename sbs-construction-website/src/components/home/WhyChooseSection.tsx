      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {whyChooseItems.map((item, index) => {
            ...
            >
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-sbs-orange-100 text-sbs-orange-600 transition-colors hover:bg-sbs-orange-500 hover:text-white">
                {icons[item.icon]}
              </div>
